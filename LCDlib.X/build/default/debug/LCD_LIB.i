...
# 42 "./LCD_LIB.h"
void LCD_init(void);
void LCD_write_char_CP (char letra);
void LCD_write_text_CP (char *text);
void LCD_write_char (char fila, char col, char letra);
...
static void Load_Cmd (char data){
    ...
    if((data & 1) == 0) LATDbits.LATD4 = 0; else LATDbits.LATD4 = 1;
    if((data & 2) == 0) LATDbits.LATD5 = 0; else LATDbits.LATD5 = 1;
    if((data & 4) == 0) LATDbits.LATD6 = 0; else LATDbits.LATD6 = 1;
    if((data & 8) == 0) LATDbits.LATD7 = 0; else LATDbits.LATD7 = 1;

    LATDbits.LATD1 = 0;
    LATDbits.LATD1 = 1;
    LATDbits.LATD1 = 0;

    _delay((unsigned long)((300)*(20000000UL/4000000.0)));
}
