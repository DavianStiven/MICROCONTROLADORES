    ...
    switch(dig){
        ...
        case 2: LATD = 0xFF;
                for(char i=0; i<=7; i++){
                    LATD &= ~(1<<i);
                    _delay((unsigned long)((200)*(20000000/4000.0)));
                    if(PORTBbits.RB0 == 1 || PORTBbits.RB1 == 0 || PORTBbits.RB2 == 1 || PORTBbits.RB3 == 1){
                        break;
                    }
                }
                LATD = 0xFF;
        ...
        case 4: LATD = 0x00;
                for(char i=0; i<7; i=i+2){
                    LATD |= (1<<i);
                    _delay((unsigned long)((200)*(20000000/4000.0)));
                    if(PORTBbits.RB0 == 1 || PORTBbits.RB1 == 1 || PORTBbits.RB2 == 0 || PORTBbits.RB3 == 1){
                        break;
                    }
                }
                LATD = 0x00;
        ...
        case 8: LATD = 0xFF;
                for(char i=7; i>0; i--){
                    LATD &= ~(1<<i);
                    _delay((unsigned long)((200)*(20000000/4000.0)));
                    if(PORTBbits.RB0 == 1 || PORTBbits.RB1 == 1 || PORTBbits.RB2 == 1 || PORTBbits.RB3 == 0){
                        break;
                    }
                }
                LATD &= ~(1<<0);
